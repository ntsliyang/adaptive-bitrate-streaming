...
#          |
#          v
url = 'http://localhost:8080/html/' + 'myindex_' + abr_algo + '.html'
...
try:
	...
	if abr_algo == 'RL':
		command = 'exec /usr/local/bin/python3.6 ../rl_server/rl_server_no_training.py ' + exp_id
		# command = 'exec /usr/local/bin/python3.6 ../rl_server/rl_server_no_training.py '
	elif abr_algo == 'fastMPC':
		command = 'exec /Users/apple/anaconda3/bin/python ../rl_server/mpc_server.py ' + exp_id
	elif abr_algo == 'robustMPC':
		command = 'exec /Users/apple/anaconda3/bin/python ../rl_server/robust_mpc_server.py ' + exp_id
	else:
		# command = 'exec /Users/apple/anaconda3/bin/python ../rl_server/simple_server.py ' + abr_algo + ' ' + exp_id
		command = 'exec /Users/apple/anaconda3/bin/python ../rl_server/simple_server.py ' + abr_algo
